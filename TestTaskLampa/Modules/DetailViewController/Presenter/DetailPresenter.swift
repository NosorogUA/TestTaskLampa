...
class DetailPresenter: DetailOutput {
    ...
    func configureCell(_ cell: DetailTableViewCell) {
        ...
        cell.setup(title: movie.title, description: movie.overview, language: movie.originalLanguage, year: movie.releaseDate, rating: movie.popularity, imageUrl: URL(string: url))
    }
}
